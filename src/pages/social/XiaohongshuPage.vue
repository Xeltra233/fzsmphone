          ...
          <div class="detail-sheet">
            ...
            <div class="detail-body">
              ...
              <div v-if="getNoteImages(selectedNote).length" class="detail-images">
                <div v-for="(img, idx) in getNoteImages(selectedNote)" :key="idx" class="img-wrapper">
                  <img :src="img" class="detail-img" alt="" />
                  <button v-if="selectedNote.imagePrompt" class="regen-btn" :disabled="store.regeneratingImages.has(`${selectedNote.id}-${idx}`)" @click.stop="store.regenerateImage('xiaohongshu', selectedNote.id, idx)">
                    <span v-if="store.regeneratingImages.has(`${selectedNote.id}-${idx}`)" class="regen-spin"></span>
